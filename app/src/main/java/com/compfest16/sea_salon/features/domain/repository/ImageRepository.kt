...
interface ImageRepository{
    suspend fun GetImageById(id: String, affiliateID: String, role: String): Flow<ImageModel>
    suspend fun GetImagesByAffiliateId(id: String, role: String): Flow<List<ImageModel>>
